...
- 14 skills (all `/autonomous-dev-loop:ad-*`): `ad-init`, `ad-bootstrap`, `ad-research`, `ad-story`, `ad-spec`, `ad-dev`, `ad-verify`, `ad-validate`, `ad-fix`, `ad-pr`, `ad-loop`, `ad-summary`, `ad-guideline`, `ad-organize`
